        ...
        <div>
            <div className="relative pt-36 ml-auto">
                <div className="lg:w-2/3 text-center mx-auto">
                    ...
                    <p className="mt-8 text-gray-700 dark:text-gray-300">Microsoft Loop is a collaborative workspace that lets teams create, share, and work together on projects seamlessly. It combines flexible pages with reusable components that sync across different apps, making it easy to stay organized and up-to-date.
                      <span className='block'>email: 'guest@gmail.com' || password: 'guest'</span>
                    </p>
                    <div className="mt-16 flex flex-wrap justify-center gap-y-4 gap-x-6">
                        ...
                        >
                          <span 
                            ...
                            ><button>Log in as Guest</button></span
                          >
                        </a>
                    </div>
